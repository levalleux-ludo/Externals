	...
	<table class="table table-striped">
		...
		<td>
		    ...
		    <form class="form-horizontal" action="action.php?action=ADD_ENGINE" method="POST" enctype="multipart/form-data">
				...
				<label class="control-label"   for="inputPassword">Type de périphérique</label>
				<div class="controls">
					<input class="span2" readonly="readonly" name="type" id="appendedDropdownButtonType" type="text">
					...
					<ul class="dropdown-menu">
						<li style="cursor:pointer;">
							<a onclick="$('#appendedDropdownButtonType').val('Prise radio');$('input[name=\'idType\']').val('0');">Prise radio</a>
						</li>
						<li style="cursor:pointer;">
							<a onclick="$('#appendedDropdownButtonType').val('Sonde de température radio');$('input[name=\'idType\']').val('1');">Sonde de température radio</a>
						</li>
					</ul>
					</div>
				</div>
